    ...
    <div class="container text-start text-dark rounded">
        <form action="{{ route('club.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div>
                ...
                <input type="text" class="form-control bg-light" name="name" id="name" placeholder="Hertha Berlin">
                @error('name')
            ...
            <div>
                ...
                <input type="text" class="form-control bg-light" name="city" id="city" placeholder="Berlin">
                @error('city')
                    <div class="text-end text-mute">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="text" class="form-control bg-light" name="stadium" id="stadium" placeholder="Olympiastadion Berlin">
                @error('stadium')
                    <div class="text-end text-mute">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="text" class="form-control bg-light" name="apparel" id="apparel" placeholder="Nike">
                @error('apparel')
                    <div class="text-end text-mute">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="text" class="form-control bg-light" name="sponsor" id="sponsor" placeholder="Autohero">
                @error('sponsor')
                    <div class="text-end text-mute">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="text" class="form-control bg-light" name="coach" id="coach" placeholder="Pál Dárdai">
                @error('coach')
                    <div class="text-end text-mute">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="text" class="form-control bg-light" name="captain" id="captain" placeholder="Dedryck Boyata">
                @error('captain')
                    <div class="text-end text-mute">{{ $message }}</div>
                @enderror
            </div>
